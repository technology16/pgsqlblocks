...
public class PgSqlBlocks_ru extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"kill_process_confirm_message", "Вы действительно хотите уничтожить выбранные процессы?"},
                {"cancel_process_confirm_message", "Вы действительно хотите послать сигнал отмены выбранных процессов?"},
