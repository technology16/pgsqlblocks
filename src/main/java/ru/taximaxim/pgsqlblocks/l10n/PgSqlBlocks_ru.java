...
public class PgSqlBlocks_ru extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"kill_process_confirm_message", "Вы действительно хотите уничтожить процесс(ы) {0}?"},
                {"cancel_process_confirm_message", "Вы действительно хотите послать сигнал отмены процесса(ов) {0}?"},
                {"cancel_process_dialog_message", "Операция отмены процессов была отменена"},
                {"cancel_process_dialog_error_message", "Операция отмены процессов завершилась с ошибкой {0}"},
                {"kill_process_dialog_message", "Операция уничтожения процессов была отменена"},
                {"kill_process_dialog_error_message", "Операция уничтожения процессов завершилась с ошибкой {0}"},
