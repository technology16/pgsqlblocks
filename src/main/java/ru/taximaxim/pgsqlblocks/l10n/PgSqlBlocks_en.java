...
public class PgSqlBlocks_en extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"cancel_process_dialog_message", "Cancelling of processes was cancelled"},
                {"cancel_process_dialog_error_message", "Cancelling of processes was finished with error {0}"},
                {"kill_process_dialog_message", "Termination of processes was cancelled"},
                {"kill_process_dialog_error_message", "Termination of processes was finished with error {0}"},
