...
* Обновлены action-ы в gitHub Actions
* Обновлена лицензия
* Убран спецальный параметр `Читать тип процесса` для 10 версии Postresql в настройках соединения. Теперь он по умолчанию включен.
